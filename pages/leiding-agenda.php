        ...
        $(document).ready(function () {
            ...
            $("#table_list_1").jqGrid({
                ...
                onSelectRow: function(id, iRow, iCol, e) {
                    location.href="<?php echo $site; ?>/leiding/bekijk/agenda/"+id+" "
                },
                pager: "#pager_list_1",
                viewrecords: true,
                hidegrid: false
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content">
                            <span class="glyphicon glyphicon-edit"></span> <a href="<?php echo $site; ?>/leiding/toevoegen/agenda">Item Toevoegen</a> 
