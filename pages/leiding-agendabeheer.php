...
?>
                ...
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb" style="width:540px;">
                        ...
                        <li>
                            <a href="<?php echo $site; ?>/leiding/agenda">Beheer Agenda</a>
                        </li>
                        <li class="active">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="afdeling" class="form-control">
                                                ...
                                                <option value="leiding" <?php if($fetchAgenda['afdeling'] == 'leiding'){echo 'selected';}?> >Leidinggevende</option>
                                                <option value="instructeur" <?php if($fetchAgenda['afdeling'] == 'instructeur'){echo 'selected';}?> >Instructeur</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
