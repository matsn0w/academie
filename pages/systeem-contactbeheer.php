...
if(isset($_GET['id'])){
    ...
    $getContact = $db->query("SELECT * FROM contact_leiding WHERE id = '".$id."'");
...
?>
                ...
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo $site; ?>/leiding/contact">Contact</a>
                        </li>
                        <li class="active">
                                ...
                                <div class="col-lg-12">
                                    <div class="m-b-md">
                                        ...
                                        if(isset($_POST['delForm'])){
                                            $q1 = $db->query("UPDATE contact_leiding SET status = '3' WHERE id = '".$id."'");
                                            if($q1){
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <dl class="dl-horizontal">
                                        ...
                                        <dt>Voor leiding:</dt> <dd><?php echo ucfirst($fetchContact['leidinggevende']); ?></dd>
                                        <dt>Datum:</dt> <dd>
                                        <?php
                                ...
                                <div class="tab-pane" id="tab-2">
                                    ...
                                    if(isset($_POST['sendForm'])){
                                        ...
                                        if(empty($onderwerp)){
                                            ...
                                            $query .= $db->query("UPDATE contact_leiding SET
