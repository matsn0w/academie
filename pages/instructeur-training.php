...
<script>
        $(document).ready(function () {
            ...
            var mydata = "<?php echo $site; ?>/includes/instructeur-training.php";
            ...
            $("#table_list_1").jqGrid({
                ...
                onSelectRow: function(id, iRow, iCol, e) {
                    location.href="<?php echo $site; ?>/instructeur/bekijk/training/"+id+" "
                },
                pager: "#pager_list_1",
                viewrecords: true,
                hidegrid: false
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5>Trainingen Beheren</h5>
                        </div>
                        <div class="ibox-content">
                            <span class="glyphicon glyphicon-edit"></span> <a href="<?php echo $site; ?>/instructeur/toevoegen/training">Item Toevoegen</a> 
