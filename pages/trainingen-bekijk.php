            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-4">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo $site; ?>/trainingen">Trainingen</a>
                        </li>
                        <li class="active">
                            <strong>Training: <?php echo $fetchTraining['title']; ?></strong>
                        </li>
                    </ol>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <dl class="dl-horizontal">
                                        ...
                                        <!--
                                        <dt>Status:</dt> <dd><span class="label label-primary">Verlopen</span></dd>
