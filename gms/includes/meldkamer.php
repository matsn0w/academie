                        ...
                        <div class="col-md-5 column">
                            <div class="panel-group" id="panel-447772">
                                ...
                                <div class="melding-title" data-toggle="collapse" data-parent="#panel-447777"
                                     href="#panel-element-483542">Eenheden uit Game
                                </div>
                                <div class="melding column">
                                ...
                                <div class="melding-title" data-toggle="collapse" data-parent="#panel-447778"
                                     href="#panel-element-483543">Eenheden koppelen aan district
                                </div>
                                <div class="melding column">
                                ...
                                <div class="melding-title-2 collapsed" data-toggle="collapse"
                                     data-parent="#panel-447773" href="#panel-element-483538">Melding maken
                                </div>
                                <div class="melding column">
                                    <div id="panel-element-483538" class="panel-collapse collapse">
                            ...
                            <div class="melding column">
                                ...
                                <div class="maak-aantekening">
                                    <form id="aantekening-form">
                                        <b>INC. ID:</b> <input type="number" name="mid" id="mid" class="form-control"
                                                               style="width:100px;">
                                        <b>Aantekening:</b>
                                        <textarea class="form-control" id="aantekening" rows="3"></textarea>
                                        <i class="form-control aantekening-send" style="width:65px;"
                                           onclick="maakaantekening()">Maak</i>
                                    </form>
                                </div>
                            </div>
                        </div>
