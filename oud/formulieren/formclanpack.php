<?php
if(isset($_GET['id'])){
    $formQ = $db->query("SELECT * FROM formclanpack WHERE id = '".$db->real_escape_string($_GET['id'])."'");
    $formF = $formQ->fetch_assoc();
?>              <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Clanpack Idee formulier: <?php echo $formF['naam']; ?>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Clanpack Idee: <?php echo $formF['naam']; ?>
                            </li>
                        </ol>
            ...
            <?php
            $getContactq = $db->query("SELECT * FROM formclanpack WHERE id = '".$db->real_escape_string($_GET['id'])."'");
            ...
            ?>
				...
				<div class="form-group">
					 <label for="exampleInputEmail1">Clanpack idee</label>
                     <textarea class="form-control" rows="10" readonly><?php echo $getContact['idee']; ?></textarea>
				</div>
